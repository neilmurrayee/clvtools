...
open work left. Anything further starts a new round and a new list — and, per
the rule below, with the evidence that raised it. Everything else is closed, and item
